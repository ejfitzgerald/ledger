...
{
  module.CreateFreeFunction<float_t>("exp", &Exp<float_t>, vm::ConstantEstimator<1>::Get());
  module.CreateFreeFunction<double_t>("exp", &Exp<double_t>, vm::ConstantEstimator<1>::Get());
